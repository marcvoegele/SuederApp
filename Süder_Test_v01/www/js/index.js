...
function setnews() {
	...
	for (i in dataset) {
		...
		news.append("br");
		news.append("p").attr("class", "right").text(dataset[i]["event"])
	};
}
...
function setevent() {
	...
	for (i in dataset) {
		news.append("h1").attr("class","right").text(dataset[i]["event"]);
		news.append("br");
		news.append("p").attr("class","right").text(dataset[i]["description"]);
	};
}
...
function sethistory() {
	...
	history.append("h1").attr("class","right").text("Geschichte");
	for (i in dataset) {
		if (dataset[i]["type"]=="title"){
			history.append("h2").class("class","right").text(dataset[i]["history"])
			history.append("br");
		} else {
			history.append("p").class("class","right").text(dataset[i]["history"])
			history.append("br");
		};
	};
}
